...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'default nil
                      :family (my/safe-font '("Fira Code" "Monaco" "Monospace"))
                      :height 130)
  ...
  (defun my/org-setup-fonts ()
    ...
    (let ((sans (my/safe-font '("Noto Sans Symbols" "Inter" "Source Sans Pro")))
          (mono (my/safe-font '("Fira Code" "Iosevka" "Source Code Symbols")))
...
#+begin_src emacs-lisp
  (use-package general
    ...
    (general-define-key
      ...
      "BB"  '(bookmark-jump :which-key "jump to bookmark")
      ...
      "be"   '(:ignore t :which-key "Eval")
      "bee"  '(eval-buffer :which-key "eval buffer")
      "ber"  '(eval-region :which-key "eval region")
      ...
      "kk"  '(kill-whole-line :which-key "kill whole line")
      "ke"  '(kill-line :which-key "kill line")
      ;; Export
